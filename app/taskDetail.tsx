        ...
        <SafeAreaView style={commonStyles.safeArea}>
            <View style={commonStyles.card}>
                ...
                <View style={commonStyles.section}>
                    ...
                    <Text style={commonStyles.textBody}>{new Date(taskData.dateTime).toLocaleString()}</Text>
                </View>
                ...
                <View style={commonStyles.section}>
                    ...
                    <Text style={commonStyles.textBody}>{new Date(taskData.createdAt).toLocaleString()}</Text>
                </View>
            </View>
        </SafeAreaView>
    );
